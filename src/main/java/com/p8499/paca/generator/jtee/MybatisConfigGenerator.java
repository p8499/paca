 ...
 */
public class MybatisConfigGenerator extends Generator0 {
    public MybatisConfigGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder) {
        return new File(folder, "src/main/webapp/WEB-INF/mybatis-config.xml");
    }

    @Override
    public String getContent() throws IOException {
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/jtee/mybatis-config.vm");
