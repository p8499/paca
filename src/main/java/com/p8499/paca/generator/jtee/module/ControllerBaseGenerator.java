 ...
 */
public class ControllerBaseGenerator extends Generator1 {
    public ControllerBaseGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder, int index) {
        ...
        String packageName = (String) ((Map) project.get("envJtee")).get("packageControllerBase");
        String className = (String) ((Map) ((List) project.get("modules")).get(index)).get("jteeControllerBaseAlias");
    ...
    public String getContent(int index) throws IOException, FormatterException {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/jtee/module/controllerBase.vm");
