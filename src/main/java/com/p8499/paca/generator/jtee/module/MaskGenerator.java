...
public class MaskGenerator extends Generator1 {
    ...
    public File getPath(File folder, int index) {
        ...
        String packageName = (String) ((Map) project.get("envJtee")).get("packageMask");
        String className = (String) ((Map) ((List) project.get("modules")).get(index)).get("jteeMaskAlias");
    ...
    public String getContent(int index) throws IOException, FormatterException {
        ...
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/jtee/module/mask.vm");
