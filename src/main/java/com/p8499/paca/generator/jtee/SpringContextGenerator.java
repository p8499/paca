 ...
 */
public class SpringContextGenerator extends Generator0 {
    public SpringContextGenerator(Map project) {
        super(project);
    ...
    public File getPath(File folder) {
        return new File(folder, "src/main/webapp/WEB-INF/springContext.xml");
    }

    @Override
    public String getContent() throws IOException {
        Template template = getVelocityEngine().getTemplate("com/p8499/paca/templates/jtee/springContext.vm");
